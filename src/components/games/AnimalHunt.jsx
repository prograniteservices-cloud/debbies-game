...
function Rig() {
  ...
  useFrame(() => {
    ...
    // Yaw: 360 degrees (Full circle)
    // Pitch: Restricted to +/- 30 degrees (prevent flipping/disorientation)
    const targetYaw = -mouse.x * Math.PI;
    const targetPitch = mouse.y * Math.PI * 0.15; // Max ~27 degrees
    ...
    // Apply rotation in YXZ order to ensure horizon stays horizontal
